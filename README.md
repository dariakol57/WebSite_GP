...
The "Antiisite Modern Album" is a single-page web application that allows you to collect and document stories about great people. It runs entirely in your browser using LocalStorage to save your data automatically without needing a backend server. 
